    ...
    <div class="row bg-secondary py-2 px-xl-5">
        <div class="col-lg-6 d-none d-lg-block">
            <div class="d-inline-flex align-items-center">
                ...
                <span class="text-muted px-2">|</span>
                <a class="text-dark" href="<%=request.getContextPath()%>/ViewServlet">Support</a>
            </div>
        </div>
            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto py-0">
                        <a href="index(nhap).html" class="nav-item nav-link">Home</a>
            ...
            <div class="row">
                <div class="col-md-4 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        <a class="text-dark mb-2" href="index(nhap).html"><i class="fa fa-angle-right mr-2"></i>Home</a>
