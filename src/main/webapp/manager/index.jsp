                        ...
                        <div class="search-box">
                            ...
                            <form action="<%=request.getContextPath()%>/SearchServlet">
                                <input type="text" class="form-control" name="search_txt"
                                       placeholder="Search by MaSv, name, phone&hellip;">
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <c:forEach items="${productList}" var="o">
                    <tr>
                        ...
                        <td>${o.image}</td>
                        <td>
                            <a href="<%=request.getContextPath()%>/DetailServlet?id=${o.id}" class="view"
                               title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                            <a href="<%=request.getContextPath()%>/DetailServlet?id=${o.id}" class="edit"
                               title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                            <a href="<%=request.getContextPath()%>/DeleteServlet?id=${o.id}" class="delete"
